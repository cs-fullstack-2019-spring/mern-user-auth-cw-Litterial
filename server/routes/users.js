...
var Auth_User=require('../models/UserSchema');
...
passport.deserializeUser(function(id, done) {
  Auth_User.findById(id, function(err, user) {
    done(err, user);
  });
});
...
passport.use(new LocalStrategy(
    function(username, password, done) {
      ...
      Auth_User.findOne({ username: username }, function (err, user) {
